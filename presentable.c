...
//    char* filename = "SINE8.WAV";
   ...
   fileLen = header.Subchunk2Size/header.ByteRate;
...
void DMA1_CH2_3_DMA2_CH1_2_IRQHandler(){
    NPUIupdate1(fileLen,currentSec);
    //NPUIupdate2(fileLen,currentSec);
    ////////////new//////
    if(f_eof(f)){
        pause();
